...
object Constants {
    ...
    // differs (e.g. a Google-TV variant), update this one line. targets is left
    // empty so the capture patch applies to any version pulled during RE; pin a
    // real AppTarget once we settle on a tested build.
