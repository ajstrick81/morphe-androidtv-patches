...
**For:** a fresh session picking this up. **Status:** investigation COMPLETE — verdict is
*Netflix is not strippable with this toolset (research-parked/closed)*. This doc is the fast
path to full context; the reasoning lives in `PORTABILITY-ASSESSMENT.md` (read it for detail).
